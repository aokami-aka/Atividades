...
echo -e "-------\">\"---------"
echo -e "O redirecionador \">\" redireciona a saída para um arquivo ou local desejado apagando o conteúdo contido nele e colocando o novo que está sendo enviado.\nEle é útil para a criação de arquivos já com conteúdo\nEX: \"echo 'teste' > arquivo.txt\""
echo -e "\n-------\">>\"--------"
echo -e "O redirecionador \">>\" redireciona a saída para um arquivo ou local desejado inserindo no final do arquivo.\nEle é útil para adicionar conteúdo ao final de arquivos\nEX: \"echo 'teste2 >> arquivo.txt\""
echo -e "\n-------\"2>\"--------"
...
echo -e "\n------\"<<<\"---------"
echo -e "O redirecinador \"<<<\" funciona como um pipe(|) invertido.\nEX: grep -i label <<< cat /etc/fstab"
